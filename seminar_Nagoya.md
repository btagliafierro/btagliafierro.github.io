...
**Organizer:** Dr. Annarosa Lettieri (Department of Engineering, Architecture, Civil Engineering, and Industrial Management Engineering)<br>
...
The presented codes are part of a well-structured pipeline that generates stress components from the definition of environmental configurations, thereby reducing the need for model hypotheses on system response, as the system is fully modeled. This software, when combined to a proper structral solver that includes wave and wind actions, constitutes a stepping stone for the design of wind turbines, for which steel remains the most widely used material.
